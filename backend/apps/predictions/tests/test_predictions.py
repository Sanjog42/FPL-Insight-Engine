...
class FPLCacheTests(APITestCase):
    ...
    @patch("apps.predictions.services.fpl_client._fetch_json")
...
class PredictionEndpointTests(APITestCase):
    ...
    @patch("apps.predictions.services.fpl_client.get_bootstrap")
    @patch("apps.predictions.services.fpl_client.get_fixtures")
    @patch("apps.predictions.services.fpl_client.get_element_summary")
